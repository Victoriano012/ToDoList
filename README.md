...
- Long-press a task and drag to reorder it, drop it onto another task to make it that task's first subtask, drop it in the gap under a subtask block to place it after the whole block, or onto "+ Add task" to put it last. # turns a task into a heading (no circle), × deletes it.
