...
- Long-press a task and drag to reorder it, drop it onto another task to nest it, drop it in the gap under a subtask block to place it after the whole block, or below the list to put it last. # turns a task into a heading (no circle), × deletes it.
